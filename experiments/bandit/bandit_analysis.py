...
all_freqs_b, avg_psd_b, ci_lower_b, ci_upper_b = process_bandit_testing(folder_path="../../data/bandit/simnibsbandit2/training",
...
plt.fill_between(all_freqs_h, ci_lower_b, ci_upper_b, color='g', alpha=0.3)
