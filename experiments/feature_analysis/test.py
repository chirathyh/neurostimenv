...
P = {}
P['HL23PN1'] = np.random.rand(100000, 3)  # Shape (100000, 3)
...
evoked.filter(l_freq=None, h_freq=100)
...
print(min(pred_evoked.data/10e-6), max(pred_evoked.data/10e-6))
...
fig.savefig('Figure6_B.jpg', facecolor='white', edgecolor='none',bbox_inches = "tight",dpi=1000)
