...
class NetworkEnv(Network):
    ...
    def init_simulation(self, probes=None, obs_win_len=None,
    ...
    def run_simulation_with_probes_loop(self, cvode,
                                        probes=None,
                                        variable_dt=False,
                                        atol=0.001,
                                        rtol=0.,
        ...
        tstep = 0
        mini_step_time = self.obs_win_len  # mini_step_time is the new tstop!
