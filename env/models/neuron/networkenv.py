...
class NetworkEnv(Network):
    ...
    def init_simulation(self, probes=None, obs_win_len=None, rec_imem=False, rec_vmem=False,
                 rec_ipas=False, rec_icap=False, rec_isyn=False, rec_vmemsyn=False, rec_istim=False,
                 rec_pop_contributions=False, rec_variables=[], variable_dt=False, atol=0.001,
                 to_memory=True, to_file=False, file_name='OUTPUT.h5', **kwargs):
    ...
    def step(self, probes=None, rec_imem=False, rec_vmem=False,rec_ipas=False,rec_icap=False,
            rec_isyn=False, rec_vmemsyn=False, rec_istim=False, rec_current_dipole_moment=False,
            rec_variables=[], dotprodcoeffs= None, to_memory=True, to_file=False,
            file_name=None, use_ipas=False, use_icap=True, use_isyn=False, rec_pop_contributions=False, **kwargs):
    ...
    def run_simulation_with_probes_loop(self, probes=None, to_memory=True, to_file=False, file_name=None,
                                     use_ipas=True, use_icap=True, use_isyn=True,rec_pop_contributions=False):
